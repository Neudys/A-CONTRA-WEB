        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h3 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
              ...
              <span className="text-muted-foreground">Somos tu socio estratégico.</span>
            </h3>

            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              <p>
                En <span className="font-bold text-foreground">A CONTRA</span>, no trabajamos con plantillas ni promesas
                vacías. Te escuchamos, contamos tu historia real y convertimos lo que eres en algo que conecta y vende.
              </p>
              <p>
                Sin humo. Sin rodeos. Solo resultados tangibles y una estética que eleva tu marca al siguiente nivel.
              </p>
            </div>

            <div className="mt-10 p-6 bg-background rounded-2xl border-l-4 border-primary shadow-sm">
              <p className="text-xl font-bold italic text-foreground">"ASÍ DE SIMPLE."</p>
            </div>

            <div className="mt-8 flex gap-4">
              <Button className="rounded-full px-8">Nuestra Historia</Button>
            </div>
          </div>
